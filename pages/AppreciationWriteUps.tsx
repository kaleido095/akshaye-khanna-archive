...
const AppreciationWriteUps = () => {
  return (
    <div className="max-w-5xl mx-auto px-6 py-20">
      <header className="mb-16 text-center">
        <h2 className="text-red-700 uppercase tracking-widest text-sm mb-4 font-bold">Heartfelt Tributes</h2>
        <h1 className="text-5xl md:text-7xl font-serif font-bold mb-8">Appreciation <span className="text-red-900">&</span> Write-ups</h1>
        <p className="text-gray-400 max-w-2xl mx-auto text-lg font-light leading-relaxed">
          Personal stories, testimonials, and heartfelt messages of admiration from fans whose lives have been touched by Akshaye Khanna's work and artistry.
        </p>
      </header>
...
export default AppreciationWriteUps;