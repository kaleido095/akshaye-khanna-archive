...
import { Lightbulb, GalleryVertical } from 'lucide-react';
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-20">
      <header className="mb-16 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-serif font-bold mb-8">Fan Projects</h1>
        <p className="text-gray-400 max-w-2xl mx-auto text-lg font-light leading-relaxed">
          A space dedicated to larger fan-driven creative endeavors, including tribute videos, compilations, and more.
        </p>
      </header>
      ...
      <div className="bg-gradient-to-br from-rose-950/20 to-black p-12 rounded-[40px] border border-rose-950/30 text-center shadow-2xl">
        ...
        <h3 className="text-3xl font-serif font-bold text-white mb-6">Got a project to share?</h3>
        <p className="text-xl text-gray-300 mb-10 leading-relaxed font-light">
          Whether it's a meticulously crafted video edit, an extensive website, or any other grand tribute, we'd love to feature it here.
        </p>
        <Link 
          to="/contact" 
      ...
      <div className="mt-20 text-center text-gray-500 text-sm uppercase tracking-[0.3em]">
        Stay tuned for featured projects!
      </div>
    </div>
  );
};
