...
const ScenePerformanceAnalysis = () => {
  return (
    <div className="max-w-7xl mx-auto px-6 py-20">
      <header className="mb-16 text-center">
        <h2 className="text-red-700 uppercase tracking-widest text-sm mb-4 font-bold">Deep Dives</h2>
        <h1 className="text-5xl md:text-7xl font-serif font-bold mb-8">Scene <span className="text-red-900">&</span> Performance Analysis</h1>
...
export default ScenePerformanceAnalysis;